...
if (!function_exists('haaski_magazine_css_custom')) {

	function haaski_magazine_css_custom() {
		...
		if (savana_lite_setting('haaski_magazine_body_font_family'))
			$css .= "body { font-family:".esc_html(haaski_magazine_google_font_name('haaski_magazine_body_font_family'))."; }";
		...
		wp_add_inline_style( 'haaski-magazine-style', $css );

	}

	add_action('wp_enqueue_scripts', 'haaski_magazine_css_custom', 999);
